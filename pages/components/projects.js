        ...
        <div id="my-work" className="min-h-[100vh] w-full flex flex-col bg-gradient-to-b from-[#f5f5f5] to-[#F8F8F8]">
            <div className="flex lg:flex-row flex-col mt-40 w-full container mx-auto">
                ...
                <div className="xl:w-2/4 lg:w-3/4 flex flex-col xl:items-start lg:items-center items-start mb-5 sm:mx-0 mx-5">
                    <Project
                        title="RaaMies"
                        descr={(props.lang === "eng" && "A site for RaaMies") || (props.lang === "nl" && "De site van RaaMies.")}
                        img={[raamies1]}
                    ...
                    <Project
                        title="SpottyFind"
                        descr={
                            (props.lang === "eng" && "An app to find and create beautiful spots on a map.") ||
                            (props.lang === "nl" && "Een app om mooie spots te vinden en creëren.")
                        }
                    ...
                    <Project
                        title="Eco-App"
                        descr={
                            (props.lang === "eng" && "An app to check the eco score of a product.") ||
                            (props.lang === "nl" && "Een app om de eco score van een product te zien.")
                        }
