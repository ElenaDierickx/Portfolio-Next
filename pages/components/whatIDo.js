...
export default function WhatIDo() {
    return (
        <div id="what-i-do" className="h-[100vh] flex sm:flex-row flex-col sm:justify-between bg-bluepink bg-cover bg-center ">
            ...
            <div className="md:mr-20 sm:mr-10 mr-0 sm:ml-0 ml-10 pt-6 sm:pt-[30rem] sm:w-2/4 w-3/4">
                ...
                <p className="sm:pt-5 pt-2 w-full xl:text-2xl lg:text-xl md:text-lg">
                    I start my design process by listening what you need. Working together with the client to create an idea. Then I start designing
                    the first prototype, after this we’ll look at it together and discuss what needs to be changed. If everything looks perfect for
                    us, it’s time to code!
                </p>
            </div>
        </div>
    );
